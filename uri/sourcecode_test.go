...
var (
	...
	targetUriCases = []struct {
		...
		},
		{
			...
			Good:      true,
			Uri:       TargetUri{Repository: RepositoryReference{Remote: &RepositoryUri{Uri: "repouri"}}, Target: "target"},
		},
		{
			Source: "repouri///::target",
			Good:   false,
		},
		{
			...
			Stringify: "repouri///@branch",
			Good:      true,
			Uri:       TargetUri{Repository: RepositoryReference{Remote: &RepositoryUri{Uri: "repouri", Branch: "branch"}}},
		},
		{
			Source:    "repouri///=commit",
			Stringify: "repouri///=commit",
			Good:      true,
			Uri:       TargetUri{Repository: RepositoryReference{Remote: &RepositoryUri{Uri: "repouri", Commit: "commit"}}},
		},
	}
)
